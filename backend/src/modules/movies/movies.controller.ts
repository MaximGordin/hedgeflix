import { Controller, Get, Headers, HttpStatus, Param, ParseIntPipe } from '@nestjs/common';
...
export class MoviesController {
  ...
  getMovie(
    @Param('id', new ParseIntPipe({ errorHttpStatusCode: HttpStatus.NOT_FOUND })) movieId: number,
